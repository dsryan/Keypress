...
c)&&(b=d[c],void 0===a[c]&&(a[c]=b));a=new C(a);if(I(a))return this._registered_combos.push(a),a};g.prototype.register_many=function(a){var c,b,d,e;e=[];b=0;for(d=a.length;b<d;b++)c=a[b],e.push(this.register_combo(c));return e};g.prototype.unregister_combo=function(a){var c,b,d,e,f;if(!a)return!1;var g=this;b=function(a){var b,c,d,e;e=[];b=c=0;for(d=g._registered_combos.length;0<=d?c<d:c>d;b=0<=d?++c:--c)if(a===g._registered_combos[b]){g._registered_combos.splice(b,1);break}else e.push(void 0);return e};
...
191:"/",192:"`",219:"[",220:"\\",221:"]",222:"'",223:"`",224:"cmd",225:"alt",57392:"ctrl",63289:"num",59:";"};-1!==navigator.userAgent.indexOf("Mac OS X")&&(k="cmd");-1!==navigator.userAgent.indexOf("Opera")&&(r["17"]="cmd");"function"===typeof define&&define.amd?define([],function(){return p}):window.keypress=p;(D=Array.prototype).indexOf||(D.indexOf=function(a){var c,b,d,e;c=d=0;for(e=this.length;d<e;c=++d)if(b=this[c],b===a)return c;return-1})}).call(this);
